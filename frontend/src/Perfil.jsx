    ...
    <div className="perfil-page">
      <section className="perfil-hero">
        <div className="nav-links">
          <button><Inicio></Inicio></button>
          <button className="btn-secondary">Volver atrás</button>
        </div>
        <h1 className="perfil-title">Ahora edita tu perfil</h1>
      </section>
        ...
        <div className="perfil-galeria">
          {["https://images.unsplash.com/photo-1555396273-367ea4eb4db5?q=80&w=1974&auto=format&fit=crop",
            ...
            <div key={i} className="perfil-card">
              ...
              <button className="card-edit" aria-label="Editar">✏️</button>
            </div>
          ))}
        </div>
      </main>
